...
# By default all these toolchains are registered by the pkl_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:pkl_toolchain",
    toolchain_type = "@com_github_rules_pkl//pkl:toolchain_type",
)
""".format(
            platform = platform,
